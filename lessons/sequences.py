...
# Seqeunces have lengths
print(len(goat))

# Sequences are iterale with for...in loops
# Meaning you can loop over them with for...in
for item in goat:
    print(item)

# Tuples, unlike lists, are immutable
# This means the following line of code would have an error
# goat[0] = "LBJ"
...
names: list[str] = ["Kris", "Alysssa", "Michael", "Lebron"]
